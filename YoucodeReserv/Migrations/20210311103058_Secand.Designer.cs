...
namespace YoucodeReserv.Migrations
{
    ...
    [Migration("20210311103058_Secand")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YoucodeReserv.Data.Resrvation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YoucodeReserv.Data.TypeReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YoucodeReserv.Data.Etudiants", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Etudiants");
                });
            ...
            modelBuilder.Entity("YoucodeReserv.Data.Resrvation", b =>
                {
                    b.HasOne("YoucodeReserv.Data.Etudiants", "RequestingStudent")
                        .WithMany()
                        .HasForeignKey("RequestingStudentId");

                    b.HasOne("YoucodeReserv.Data.TypeReservation", "ReservationType")
                        .WithMany()
